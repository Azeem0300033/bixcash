...
@section('content')  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __("Franchise") }}</h4>
										<ul class="links">
											<li>
												<a href="{{ route('admin.dashboard') }}">{{ __("Dashboard") }} </a>
											</li>
											<li>
												<a href="javascript:;">{{ __("Franchise") }}</a>
											</li>
											<li>
												<a href="{{ route('admin-franchise-index') }}">{{ __("Franchise List") }}</a>
											</li>
										</ul>
								</div>
							</div>
						...
						<div class="product-area">
							<div class="row">
								...
								<div class="heading-area">
									<h4 class="title">
										{{ __("Franchise Registration") }} :
									</h4>
	                                <div class="action-list" >
	                                    <a style="width: 150px;"  class="add-btn" data-href="{{route('admin-franchise-create')}}" id="add-data" data-toggle="modal" data-target="#modal1">
	                                        <i class="fas fa-plus"></i> {{ __("Add Franchise") }}
	                                        </a>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
		                                                  ...
		                                                  <th>{{ __("Franchise Email") }}</th>
		                                                  <th>{{ __("Franchise Number") }}</th>
		                                                  <th>{{ __("Status") }}</th>
		                                                  <th>{{ __("Options") }}</th>
														</tr>
													</thead>
...
<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
  <div class="modal-dialog">
	...
	<div class="modal-header d-block text-center">
      ...
      <!-- Modal body -->
      <div class="modal-body">
            <p class="text-center">{{__("You are about to delete this Franchise. Every informtation under this Franchise will be deleted.")}}</p>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-franchise-datatables') }}',
               columns: [
