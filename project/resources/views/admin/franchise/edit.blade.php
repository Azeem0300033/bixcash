								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-franchise-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="shop_name" placeholder="{{ __("Franchise Name") }}" required="" value="{{ $data->shop_name }}">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="shop_number" placeholder="{{ __("Franchise Number") }}" required="" value="{{ $data->shop_number }}">
													</div>
												</div>
