                                    ...
                                    <table id="geniustable" class="table table-hover dt-responsive dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="geniustable_info" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th width="40%" class="sorting_disabled" rowspan="1" colspan="1" >Bus Name</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" >User Name</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" >Phone</th>
                                                <th class="sorting_disabled" rowspan="1" colspan="1" >Seats No</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{$item->phone}}</td>
                                                <td>
                                                    @foreach(App\Models\Seat_Checkout::where('checkout_id',$item->id)->get() as $item)
                                                        {{$item->seats}} , 
                                                    @endforeach
                                                </td>
                                            </tr>
