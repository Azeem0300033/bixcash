                    ...
                    <div class="table-responsiv">
                        <div id="geniustable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="row btn-area">
                                ...
                                <div class="col-sm-4 table-contents"><a class="add-btn" href="/admin/seat/create"><i class="fas fa-plus"></i> Add New Seat</a></div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="geniustable" class="table table-hover dt-responsive dataTable no-footer dtr-inline" cellspacing="0" width="100%" role="grid" aria-describedby="geniustable_info" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_disabled" rowspan="1" colspan="1" style="width: 99px;">Seat No</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{$item->seat_no}}</td>
                                                <td>
                                            <a class="btn success" href="/admin/seat/{{$item->id}}/edit"
