<li>
    ...
    <li>
        <a href="#franchise" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="icofont-user"></i>{{ __('Franchise') }}
        </a>
        <ul class="collapse list-unstyled" id="franchise" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-franchise-index') }}"><span>{{ __('Franchise List') }}</span></a>
            </li>
    ...
    <li>
        <a href="#level1" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
                <i class="icofont-verification-check"></i>{{ __('Levels') }}
        </a>
        <ul class="collapse list-unstyled" id="level1" data-parent="#accordion">
            <li>
                <a href="{{ route('admin-level-tree') }}"><span>{{ __('All Level') }}</span></a>
            </li>
            
            <li>
                <a href="{{ route('admin-user-payment') }}"><span>{{ __('Level Payout') }}</span></a>
            </li>
    ...
    <li>
        <a href="/admin/bus" class=" wave-effect"><i class="fas fa-bus"></i>Bus</a>
    </li>
    
    <li>
        <a href="/admin/BookingSeat" class=" wave-effect"><i class="fas fa-bus"></i>All Bus Booking</a>
    </li>
