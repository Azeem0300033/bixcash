<?php
  ...
  Route::post('/jazzcash-submit', 'LocalPaymentController@jazzcash')->name('jazzcash.submit');
...
Route::prefix('admin')->group(function() {
  ...
  //------------ ADMIN LOGIN SECTION ------------
   Route::get('/level/tree', 'Admin\UserController@treeview')->name('admin-level-tree');
   Route::get('/level/tree_view', 'Admin\UserController@treedatatable')->name('admin-level-views');
   Route::get('/level/treeview/{id}', 'Admin\UserController@treeview')->name('admin-level-trees');
  
  Route::get('/franchise/datatables', 'Admin\FranchiseController@datatables')->name('admin-franchise-datatables');
  Route::get('/franchise', 'Admin\FranchiseController@index')->name('admin-franchise-index');
  Route::get('/franchise/{id}/show', 'Admin\FranchiseController@show')->name('admin-franchise-show');
  Route::get('/franchise/edit/{id}', 'Admin\FranchiseController@edit')->name('admin-franchise-edit');
  Route::post('/franchise/edit/{id}', 'Admin\FranchiseController@update')->name('admin-franchise-update');
  Route::get('/franchise/create', 'Admin\FranchiseController@create')->name('admin-franchise-create');
  Route::post('/franchise/create', 'Admin\FranchiseController@store')->name('admin-franchise-add');
  
  Route::get('/payment/datatables', 'Admin\UserController@paymentdatatables')->name('admin-payout-datatable');
  Route::get('/payment/payout', 'Admin\UserController@paymentview')->name('admin-user-payment');
 
  
  Route::get('/franchise/status/{id1}/{id2}', 'Admin\FranchiseController@status')->name('admin-franchise-st');
  Route::get('/franchise/delete/{id}', 'Admin\FranchiseController@destroy')->name('admin-franchise-delete');
  ...
  Route::get('/logout', 'Admin\LoginController@logout')->name('admin.logout');
   ...
   Route::get('/bus/edit/{id}', 'Admin\BusController@edit')->name('admin-bus-edit');
  Route::post('/bus/edit/{id}', 'Admin\BusController@update')->name('admin-bus-update');
  Route::resource('/bus', 'Admin\BusController');
  Route::get('/seat/edit/{id}', 'Admin\SaetController@edit')->name('admin-seat-edit');
  Route::post('/seat/edit/{id}', 'Admin\SaetController@update')->name('admin-seat-update');
    Route::resource('/seat', 'Admin\SaetController');
    Route::resource('/BookingSeat', 'Admin\BookingSeatController');
  ...
  Route::get('/order/test/', 'Admin\UserPaymentMasterController@test')->name('admin-order-test');
...
// User Orders
  ...
  Route::get('/order/update/{id}', 'User\OrderController@update')->name('user-order-update');
...
// User Admin Send Message Ends
  ...
  Route::get('/affilate/wallet/amount', 'User\WithdrawController@walletamount')->name('user-wallet-amount');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/Bus-Checkout/{id}', 'Front\SearchingController@buscheckout');
  Route::get('/Slip', 'Front\SearchingController@slip');
  
  Route::post('/BusChecout', 'Front\SearchingController@CheckoutDataCall');
  
  
  Route::get('/Bus-Single/{id}', 'Front\SearchingController@busshow');
  
  Route::get('/listing', 'Front\SearchingController@listing');
  Route::resource('/Bus-Search', 'Front\SearchingController');
  Route::post('/search-bus', 'Front\SearchingController@some_method');
